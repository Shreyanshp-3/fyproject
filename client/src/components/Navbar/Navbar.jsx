        ...
        >
            ...
            >
                ...
                {/* <MenuItem to="/" text-size="1.3rem" isLast>
                    ...
                    // onClick/</MenuItem>={handleLogout}
                    >
                        <Link className="nav-link" to="/Profile/Profile">Profile</Link>
...
const NavBarContainer = ({ children, ...props }) => {
    ...
    return (
        <Flex
            ...
            pr={{ base: "2rem", md: "3rem", xl: "2rem" }}
            pl={{ base: "2rem", md: "3rem", xl: "5rem" }}
